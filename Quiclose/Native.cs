...
/// <summary>
/// Usages and related info for native Win32.
/// </summary>
internal static partial class Native {

    public static bool IsKeyPressed (VK key) => IsKeyPressedFromState(GetAsyncKeyState((int) key));

    [LibraryImport("user32.dll")]
    private static partial short GetAsyncKeyState ([MarshalAs(UnmanagedType.I4)] int vKey);

    // https://stackoverflow.com/a/48325924
    // Check if the MSB is set. If so, then the key is pressed.
    private static bool IsKeyPressedFromState (short keyState) => ((keyState >> 15) & 0x0001) == 0x0001;

}

// https://gist.github.com/alekseynemiro/dbb869443239b435b48ea767456e343a
/// <summary>
/// Virtual-Key Codes.
/// </summary>
/// <remarks>
